...
.method public static synthetic a(Lcom/google/android/exoplayer2/offline/DownloadManager;[Lcom/google/android/exoplayer2/offline/DownloadAction;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/offline/DownloadManager;->lambda$null$0([Lcom/google/android/exoplayer2/offline/DownloadAction;)V
...
.method public static synthetic b(Lcom/google/android/exoplayer2/offline/DownloadManager;[Lcom/google/android/exoplayer2/offline/DownloadAction;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/offline/DownloadManager;->lambda$saveActions$2([Lcom/google/android/exoplayer2/offline/DownloadAction;)V

    return-void
.end method

.method public static synthetic c(Lcom/google/android/exoplayer2/offline/DownloadManager;)V
    .locals 0

    invoke-direct {p0}, Lcom/google/android/exoplayer2/offline/DownloadManager;->lambda$loadActions$1()V
...
.method private synthetic lambda$loadActions$1()V
    ...
    .line 1
    :try_start_0
    iget-object v1, p0, Lcom/google/android/exoplayer2/offline/DownloadManager;->actionFile:Lcom/google/android/exoplayer2/offline/ActionFile;

    iget-object v2, p0, Lcom/google/android/exoplayer2/offline/DownloadManager;->deserializers:[Lcom/google/android/exoplayer2/offline/DownloadAction$Deserializer;

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/offline/ActionFile;->load([Lcom/google/android/exoplayer2/offline/DownloadAction$Deserializer;)[Lcom/google/android/exoplayer2/offline/DownloadAction;

    move-result-object v1

    const-string v2, "Action file is loaded."

    .line 2
    invoke-static {v2}, Lcom/google/android/exoplayer2/offline/DownloadManager;->logd(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v3, "Action file loading failed."
    ...
    new-array v1, v0, [Lcom/google/android/exoplayer2/offline/DownloadAction;

    .line 4
    :goto_0
    iget-object v2, p0, Lcom/google/android/exoplayer2/offline/DownloadManager;->handler:Landroid/os/Handler;

    new-instance v3, Lcom/google/android/exoplayer2/offline/c;

    invoke-direct {v3, p0, v1, v0}, Lcom/google/android/exoplayer2/offline/c;-><init>(Lcom/google/android/exoplayer2/offline/DownloadManager;[Lcom/google/android/exoplayer2/offline/DownloadAction;I)V
...
.method private synthetic lambda$null$0([Lcom/google/android/exoplayer2/offline/DownloadAction;)V
    .locals 5
...
.method private synthetic lambda$saveActions$2([Lcom/google/android/exoplayer2/offline/DownloadAction;)V
    .locals 1
...
.method private saveActions()V
    ...
    invoke-direct {v2, p0, v0, v3}, Lcom/google/android/exoplayer2/offline/c;-><init>(Lcom/google/android/exoplayer2/offline/DownloadManager;[Lcom/google/android/exoplayer2/offline/DownloadAction;I)V
...
.method public release()V
    ...
    invoke-direct {v2, v0}, Lcom/google/android/exoplayer2/offline/d;-><init>(Landroid/os/ConditionVariable;)V
