...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `source_theme` SET `position` = ?,`theme_id` = ?,`zh_name` = ?,`ch_name` = ?,`en_name` = ?,`zip_url` = ?,`source_path` = ?,`download_state` = ?,`thumbnail_url` = ?,`thumbnail_path` = ?,`song_id` = ?,`version` = ?,`builtin` = ?,`memory_theme` = ?,`update_time` = ? WHERE `position` = ?"
