...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "INSERT OR REPLACE INTO `resource_fx` (`fx_id`,`position`,`duration`,`fx_type`,`zh_name`,`ch_name`,`en_name`,`thumbnail_url`,`thumbnail_path`,`resource_url`,`resource_path`,`resource_hash`,`resource_size`,`category`,`download_state`,`builtin`,`new_resource`,`version`,`update_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
